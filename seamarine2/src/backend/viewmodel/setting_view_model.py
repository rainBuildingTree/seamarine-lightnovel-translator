...
class SettingViewModel(QObject):
    ...
    def open_api_reset(self):
        try:
            ...
            self.logger.info(str(self) + ".open_api_reset")
        except Exception as e:
            self.logger.error(str(self) + str(e))
    @Slot()
    def open_pipeline_setting(self):
        try:
            ...
            self.logger.info(str(self) + ".open_pipeline_setting")
        except Exception as e:
            self.logger.error(str(self) + str(e))
    @Slot()
    def open_ai_setting(self):
        try:
            ...
            self.logger.info(str(self) + ".open_ai_setting")
        except Exception as e:
            self.logger.error(str(self) + str(e))
    @Slot()
    def open_about(self):
        try:
            ...
            self.logger.info(str(self) + ".open_about")
        except Exception as e:
            self.logger.error(str(self) + str(e))
    @Slot()
    def close(self):
