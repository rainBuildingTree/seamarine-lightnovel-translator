    ...
    ColumnLayout {
        ...
        RowLayout {
            MyComponents.CircularButton {
                ...
                onClicked: reviewSettingViewModel.close()
            }
            MyComponents.CircularButton {
                id: questionButton
                ...
                onClicked: reviewSettingViewModel.open_guide_link()
            }
            Item {
            ...
            MyComponents.CircularButton {
                ...
                onClicked: reviewSettingViewModel.save_data()
            }
        }
        ...
        RowLayout {
            ...
            ComboBox {
                ...
                model: reviewSettingViewModel.llmModelList

                onActivated: (index) => {
                    reviewSettingViewModel.update_model(index)
                }
            }
            ...
            MyComponents.CircularButton {
                ...
                onClicked: {
                    reviewSettingViewModel.set_default("name")
                }
            }
        ...
        RowLayout {
            ...
            MyComponents.CircularButton {
                ...
                onClicked: reviewSettingViewModel.set_default("sys prompt")
            }
        ...
        MyComponents.ModelSettingComponent {
            ...
            fieldText: reviewSettingViewModel.temp
            onTextEdited: reviewSettingViewModel.temp = fieldText
            onClicked: {
                reviewSettingViewModel.set_default("temp")
                fieldText = reviewSettingViewModel.temp
            }
        }
        ...
        MyComponents.ModelSettingComponent {
            ...
            fieldText: reviewSettingViewModel.topP
            onTextEdited: reviewSettingViewModel.topP = fieldText
            onClicked: {
                reviewSettingViewModel.set_default("top p")
                fieldText = reviewSettingViewModel.topP
            }
        }
        ...
        MyComponents.ModelSettingComponent {
            ...
            fieldText: reviewSettingViewModel.freqPenalty
            onTextEdited: reviewSettingViewModel.freqPenalty = fieldText
            onClicked: {
                reviewSettingViewModel.set_default("freq penalty")
                fieldText = reviewSettingViewModel.freqPenalty
            }
        }
        ...
        RowLayout {
            ...
            MyComponents.CircularCheckbox {
                ...
                checked: reviewSettingViewModel.useThinkingBudget
                onClicked: reviewSettingViewModel.useThinkingBudget = !checked
            }
            ...
            MyComponents.CircularButton {
                ...
                onClicked: {
                    reviewSettingViewModel.set_default("use thinking budget")
                    reviewSettingViewModel.set_default("thinking budget")
                    thinkingBudgetField.editingFinished()
                    thinkingBudgetField.focus = false
                    thinkingBudgetField.text = reviewSettingViewModel.thinkingBudget
                }
            }
        ...
        Text {
            ...
            Layout.alignment: Qt.AlignHCenter
            Layout.margins: 4
            visible: reviewSettingViewModel.saveFailed
            text: qsTr("저장 실패!")
            font.family: root.pageFont.family
            font.pixelSize: 14
            font.bold: true
        ...
        Text {
            ...
            Layout.alignment: Qt.AlignHCenter
            Layout.margins: 4
            visible: reviewSettingViewModel.saveSucceed
            text: qsTr("저장 성공!")
            font.family: root.pageFont.family
            font.pixelSize: 14
            font.bold: true
