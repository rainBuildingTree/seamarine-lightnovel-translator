...
Page {
    ...
    Component.onCompleted: {
        userDictEditViewModel.lazy_init()
        dictListView.model = []
        dictListView.model = userDictEditViewModel.data
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            MyComponents.CircularButton {
                ...
                Layout.leftMargin: 8
                Layout.topMargin: 8
                onClicked: userDictEditViewModel.close()
            }
            ...
            MyComponents.CircularButton {
                ...
                Layout.topMargin: 8
                onClicked: userDictEditViewModel.save_csv()
            }
        }
        ...
        ListView {
            ...
            Layout.bottomMargin: 2
            Layout.topMargin: 2
            model: userDictEditViewModel.data
            clip: true
            spacing: 10
            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    TextField { id: fromField
                        ...
                        onTextEdited: {
                            userDictEditViewModel.update_data(listElement.index, "from", text)
                        }
                    }
                    Text {
                    ...
                    TextField {
                        ...
                        onTextEdited: {
                            userDictEditViewModel.update_data(listElement.index, "to", text)
                        }
                    }
                    ...
                    MyComponents.CircularButton {
                        ...
                        onClicked: {
                            userDictEditViewModel.remove_row(listElement.index)
                            dictListView.model = []
                            dictListView.model = userDictEditViewModel.data
